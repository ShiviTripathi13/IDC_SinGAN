...
def get_arguments():
    ...
    parser.add_argument('--input_dir', default='Input', help='Directory containing the input images folder')
    parser.add_argument('--input_name', required=True, help='Input image file name (e.g., church.jpg)')
    parser.add_argument('--input_mask', default='', help='Input mask file name (optional, e.g., church_mask.png)')
    ...
    parser.add_argument('--nfc', type=int, default=32, help='Base number of filters')
    parser.add_argument('--ker_size', type=int, default=3, help='Kernel size for convolution layers')
    parser.add_argument('--padd_size', type=int, default=1, help='Padding size for convolution layers')
